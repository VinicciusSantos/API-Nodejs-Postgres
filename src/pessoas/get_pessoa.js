...
<<<<<<< HEAD
    const tarefas = await cliente
                                .query(`SELECT tr.* FROM pessoas AS pe
    ...
    const projetos = await cliente
                                .query(`SELECT pr.pr_id, pr.pr_nome, pr.pr_descricao, pr.pr_status, pr.pr_data_criacao, pr.pr_data_finalizacao FROM projetos AS pr
